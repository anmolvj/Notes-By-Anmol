...
* Being open-minded is much more important than being bright or smart. No matter how much they know, close-minded people will waste your time.
...
* Think about peoples believability to access the likelihood that their opinions are good.
* The only purpose of money is to get what you want so think hard about what you value and put it above money.
* Watch out for the unfocused and the unproductive theoretical “should”. A theoretical "should" occurs when people assume that others or themselves should be able to do something when they don't know whether they can.
...
* We work with others to get three things:
  ...
  * Leverage to accomplish our chosen mission in a bigger and better way than we can achieve alone.
  * Quality relationships that make for a great community.
  * Money that allows us to buy what we need and want for ourselves or others.
* Since the relative importance of these varies by person it's up to you to determine the quantities and mix you want. The most important thing is to realize that they are mutually supportive.
...
* Don't overs squeeze dots. A dot is just one piece of data from one moment in time. Keep that in perspective while synthesizing it. You need to know how much learning you can get out of any single dot without overweighting it.
...
* Evaluate the merits of a past decision based not on what you know now but only on what you could have reasonably known at the time the decision was made. You can't evaluate choices in retrospect without the appropriate context.
...
* Use double do instead of double-checking to ensure mission-critical tasks are done correctly.
...
* To be great one can't compromise the uncompromisable.
* Know that nobody can see themselves objectively.
* While it is straightforward to have a meritocracy in activities in which there is a clarity of relative abilities because the result speaks for themselves such as in sports where the fastest runner wins the race. It is much harder in a creative environment where different points of view about what's best have to be resolved.
...
* While the best designs are built from a rich understanding of actual problems - when you are just starting out on something you often have a design based on anticipated problems as opposed to actual ones.
...
* See things from a higher level. In other words, you must get out of your own head to consider your views as just some among many and look down on the full array of points of view to access them in an idea meritocratic way rather than just in your own possessive way.
